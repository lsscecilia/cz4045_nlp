...
- Please place the Yelp Dataset (reviewSelected100.json) in the 'data' folder
- The data folder should contain all the three files as shown below. 
...
Python Dependencies
  ...
  1. VADER - Sentiment Analysis Tool provided by NLTK (https://www.nltk.org/_modules/nltk/sentiment/vader.html)
 ...
 11. CNA Post Documents - Can be found in the 'data' folder
...
contextual knowledge. Due to this limitation, model accuracy during training is decreased forming instances of invalid predictions. However, there are also cases where the model successfully identifies the valid label although the actual label assigned by VADER is wrong.
